...
public class GameController : MonoBehaviour, IGvrGazeResponder {
  ...
  void Start() {
	startingPosition = HandleObject.transform.localPosition;
    SetGazedAt(false);
  }
  ...
  public void Reset() {
	HandleObject.transform.localPosition = startingPosition;
  }
